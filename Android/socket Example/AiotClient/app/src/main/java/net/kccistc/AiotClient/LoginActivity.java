...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextIp = findViewById(R.id.editTextLoginIp);
        editTextPort = findViewById(R.id.editTextLoginPort);
        editTextId = findViewById(R.id.editTextLoginId);
        editTextPw = findViewById(R.id.editTextLoginPasswd);
