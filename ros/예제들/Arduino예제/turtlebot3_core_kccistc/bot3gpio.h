#ifndef _ROS_SERVICE_bot3gpio_h
#define _ROS_SERVICE_bot3gpio_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char BOT3GPIO[] = "bot3_kccistc_service/bot3gpio";

  class bot3gpioRequest : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return BOT3GPIO; };
    virtual const char * getMD5() override { return "36d09b846be0b371c5f190354dd3153e"; };

  };

  class bot3gpioResponse : public ros::Msg
  {
    public:
