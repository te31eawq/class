...
void gpioCallback(const bot3gpio::Request & req, bot3gpio::Response & res){
  ...
  digitalWrite(led_pin_user[0], led1);
  digitalWrite(led_pin_user[1], led2);
  digitalWrite(led_pin_user[2], led3);
  digitalWrite(led_pin_user[3], led4);

              

  getVal += digitalRead(led_pin_user[0]);
  getVal += digitalRead(led_pin_user[1])*10;
  getVal += digitalRead(led_pin_user[2])*100;
  getVal += digitalRead(led_pin_user[3])*1000;
  ...
  //   if(ledVal & (1 << j))
  //   {
  //     digitalWrite(led_pin_user[j], HIGH);
  //   }
  //   else
  //   {
