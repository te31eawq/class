...
public:
	...
	void line(Point pt1, Point pt2) override
	{
		...
		std::cout << "pt1=" << pt1.x << "," << pt1.y << " <式式式式式式式式式式式式式式式式式式式式式式式式式> " << "pt2=" << pt2.x << "," << pt2.y << std::endl;
	};
	...
	void rectangle(Point pt_tl, Point pt_br) override
	{
		...
		std::cout << "pt1=" << pt_tl.x << "," << pt_tl.y << " 仃 " << "pt2=" << pt_br.x << "," << pt_br.y << std::endl;
	};
...
int main()
{
	...
	vPt.push_back(Point(10, 30));
	vPt.push_back(Point(10, 20));
