...
volatile int tim3Sec;
volatile unsigned int tim3;
volatile unsigned int tim3Cnt;
int keyNo = 0;
int saveparameter = 500;
int pulse = 500;
int startstate = 0;
/* USER CODE END PV */
...
//	  		  else if(letsgo <= 0)
//	  			  letsgo = 0;
//	  		  __HAL_TIM_SetCompare(&htim3, TIM_CHANNEL_1, letsgo);
//	  		  printf("letsgo : %d\r\n",letsgo);
//	  	  }
